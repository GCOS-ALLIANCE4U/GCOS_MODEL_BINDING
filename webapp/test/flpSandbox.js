		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5 Model Binding",
									"targetURL": "#gcosmodelbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gcosmodelbinding-display": {
								"semanticObject": "gcosmodelbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gcosmodelbinding",
									"url": sap.ui.require.toUrl("gcosmodelbinding")
								}
							}
						}
					}
